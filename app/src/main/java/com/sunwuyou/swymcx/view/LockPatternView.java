 ...
 * 2018/7/14.
 * content
 *         * Created by Jackie on 2015/12/24. 图案解锁
...
public class LockPatternView extends View {
     ...
     * 正常状态的颜色
     */
    private static final int NORMAL_COLOR = 0xFF5AEB5A;
    /**
     * 选中状态的颜色
     */
    private static final int SELECTED_COLOR = 0xFF8FE4E7;
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        mSelectedPointViewList = new ArrayList<PointView>();
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (mIsFinished) {
            if (mSelectedPointViewList.size() == 1) {
                mSelectedPointViewList.clear();
                // 这里修改绘制 几个点
            } else if (mSelectedPointViewList.size() < 4 && mSelectedPointViewList.size() > 0) {
                // 绘制错误
                if (mOnPatternChangeListener != null) {
