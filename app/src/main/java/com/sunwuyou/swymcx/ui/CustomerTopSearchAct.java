...
public class CustomerTopSearchAct extends BaseHeadActivity implements AutoTextView.OnTextChangeListener, AdapterView.OnItemClickListener {
    ...
    private void loadData() {
        ...
        ArrayAdapter<String> localArrayAdapter = new ArrayAdapter<String>(CustomerTopSearchAct.this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        startActivityForResult(new Intent().setClass(this, NewCustomerAddOnlyForShowAct.class).putExtra("updatecustomerid", customerThin.getId()), 0);
