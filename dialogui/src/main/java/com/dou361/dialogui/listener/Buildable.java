...
public class Buildable {
    ...
    private BuildBean buildDatePick(final BuildBean bean) {
        ...
        RelativeLayout rl_title_panel = root
                .findViewById(R.id.rl_title_panel);
        FrameLayout flFirst = root
                .findViewById(R.id.fl_first);
        FrameLayout flNext = root
                .findViewById(R.id.fl_next);
        TextView tv_title = root
                .findViewById(R.id.tv_title);
        TextView tv_first = root
                .findViewById(R.id.tv_first);
        TextView tv_next = root
                .findViewById(R.id.tv_next);
        FrameLayout fl_top_customPanel = root
                .findViewById(R.id.fl_top_customPanel);
        final DateSelectorWheelView dwvDate = root
                .findViewById(R.id.dwv_date);
        FrameLayout fl_bottom_customPanel = root
