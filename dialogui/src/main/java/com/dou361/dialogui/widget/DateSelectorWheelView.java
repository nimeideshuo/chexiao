...
public class DateSelectorWheelView extends RelativeLayout implements
    ...
    private void initLayout(Context context) {
        LayoutInflater.from(context).inflate(R.layout.dialogui_datepick_date_selector_layout, this,
                true);
        rlTitle = findViewById(R.id.rl_date_time_title);
        lineL = findViewById(R.id.line_1);
        llWheelViews = findViewById(R.id.ll_wheel_views);
        tvSubTitle = findViewById(R.id.tv_date_time_subtitle);
        tvYear = findViewById(R.id.tv_date_time_year);
        tvMonth = findViewById(R.id.tv_date_time_month);
        tvDay = findViewById(R.id.tv_date_time_day);
        tvHour = findViewById(R.id.tv_date_time_hour);
        tvMinute = findViewById(R.id.tv_date_time_minute);
        tvSecond = findViewById(R.id.tv_date_time_second);
        line0 = findViewById(R.id.tv_date_time_line0);
        tv_empty = findViewById(R.id.tv_date_time_empty);
        tv_line1 = findViewById(R.id.tv_date_time_line1);
        tv_line2 = findViewById(R.id.tv_date_time_line2);

        wvYear = findViewById(R.id.wv_date_of_year);
        wvMonth = findViewById(R.id.wv_date_of_month);
        wvDay = findViewById(R.id.wv_date_of_day);
        wvHour = findViewById(R.id.wv_date_of_hour);
        wvMinute = findViewById(R.id.wv_date_of_minute);
        wvSecond = findViewById(R.id.wv_date_of_second);
