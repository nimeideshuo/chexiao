...
public class PasswordEditText extends AppCompatEditText {
    ...
    // 模式的显示图标
    @DrawableRes
    private int mShowPwdIcon = R.mipmap.icon_hide;

    // 模式的加密图标
    @DrawableRes private int mHidePwdIcon = R.mipmap.icon_disp;

//    @DrawableRes private int leftIcon=R.mipmap.icon_disp;
...
//        Drawable drawable1=ContextCompat.getDrawable(getContext(),leftIcon);
        if (shouldShowIcon) {
